...
| `NEXT_PUBLIC_MAP_TILES_URL` + `NEXT_PUBLIC_MAP_TILES_ATTRIBUTION` | Solo para cambiar de proveedor de mosaicos del mapa. Vacías = mosaicos **estándar de OpenStreetMap**, que **no requieren llave ni cuenta** |
