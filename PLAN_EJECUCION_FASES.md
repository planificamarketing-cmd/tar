...
- [x] **Mosaicos del mapa sin llave**: CARTO empezó a estampar "API KEY REQUIRED" sobre los mosaicos servidos sin llave (detectado el 2026-08-29 en las pruebas de navegador) → se cambió al servidor **estándar de OpenStreetMap**, que responde limpio y tampoco pide cuenta.
